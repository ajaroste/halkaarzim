  ...
  return (
    <footer className="footer">
      <div className="container footerGrid">
        ...
        <div><strong>Keşfet</strong><Link href="/halka-arzlar">Halka arzlar</Link><Link href="/gundem">Şirket gündemi</Link><Link href="/hakkimizda">Hakkımızda</Link><Link href="/feed.xml">RSS akışı</Link></div>
