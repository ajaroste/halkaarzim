  ...
  return (
    <footer className="footer">
      <div className="container footerGrid">
        ...
        <div><strong>Ürün</strong><Link href="/halka-arzlar">Halka arzlar</Link><Link href="/gundem">Şirket gündemi</Link></div>
        <div><strong>Yasal</strong><Link href="/gizlilik">Gizlilik ve KVKK</Link><Link href="/kullanim-kosullari">Kullanım koşulları</Link></div>
      </div>
