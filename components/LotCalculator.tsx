...
export function LotCalculator({ price, retailLots }: { price: number; retailLots: number }) {
  ...
  return (
    <div className="calculator">
      <label>Katılım bütçen<input type="number" min="0" step="100" value={budget} onChange={(e) => setBudget(Number(e.target.value))} /></label>
      <label>Tahmini bireysel katılımcı<input type="number" min="1" step="10000" value={participants} onChange={(e) => setParticipants(Number(e.target.value))} /></label>
