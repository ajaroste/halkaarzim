...
export function AdminConsole() {
  ...
  if (!isSupabaseConfigured()) return <article className="panel"><h2>Yönetim bağlantısı</h2><p>Bağlantı hazır olduğunda moderasyon ve veri düzeltme araçları burada çalışır.</p></article>;
