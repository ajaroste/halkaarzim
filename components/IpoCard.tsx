...
export function IpoCard({ ipo }: { ipo: Ipo }) {
  const code = ipo.ticker || "KOD BEKLENİYOR"; const completeness = ipo.dataCompleteness || 0;
  return <article className="ipoCard">
    ...
    <div className="aiSnippet"><AiScore score={ipo.aiScore} compact /><p>{ipo.aiSummary}</p></div>
